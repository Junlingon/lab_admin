<template>
  <div class="userlist">
    ...
    <AuditUserDetails @savebtn="delsavebtn" ref="AuditUserDetailsRef"></AuditUserDetails>
  </div>
</template>

<script setup>
import AuditUserDetails from "@/view/admin/audit/audit_user_details.vue"
...
const AuditUserDetailsRef = ref(null) //审核详情组件
...
const detailsbtn = (type, e) => {
  AuditUserDetailsRef.value.blockfunc(type, e);
}


//获取列表
const getlist = async (e) => {
  const res = await proxy.$api.AdminApi.AuditUserList({
