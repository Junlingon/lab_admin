  ...
  <div class="userlist">
    ...
    <el-card class="mt20">
      ...
      >
        ...
        <el-table-column label="竞赛网址" prop="websiteUrl" />
        <el-table-column label="参赛学生" prop="principal" />
        <el-table-column label="指导老师" prop="adviser" />
        <el-table-column label="参赛时间" prop="time" />
...
const getlist = async (e) => {
  const res = await proxy.$api.AdminApi.infoList({
