<template>
  <el-dialog v-model="dialogTableVisible" title="问题详情" width="70%">
    <el-descriptions border :column=" store.openshow ?  1 : 3">
      <el-descriptions-item label="标题">{{ myinfo.name }}</el-descriptions-item>
      <el-descriptions-item label="回答">{{ myinfo.msg }}</el-descriptions-item>
