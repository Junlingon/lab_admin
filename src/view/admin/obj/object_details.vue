<template>
  <el-dialog v-model="dialogTableVisible" title="项目详情" width="70%">
    <el-descriptions border :column="store.openshow ? 1 : 3">
      ...
      <el-descriptions-item label="状态">
        <el-tag v-if="myinfo.status == 1" type="primary">正常</el-tag>
        <el-tag v-if="myinfo.status == 2" type="success">失效</el-tag>
      </el-descriptions-item>
...
const getdetails = async (e) => {
  const res = await proxy.$api.AdminApi.projectSearchone({ id: id.value });
