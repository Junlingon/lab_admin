  ...
  <div class="userlist">
    ...
    <el-card class="mt20">
      <el-table
        ...
        scrollbar-always-on
      >
        <el-table-column label="智能车编号" prop="smartCarId" />
        <el-table-column label="智能车名" prop="smartCarName" />
        <el-table-column label="赛道编号" prop="trackId" />
        <el-table-column label="赛道名" prop="trackName" />
        <el-table-column label="元素编号" prop="elementId" />
        <el-table-column label="元素名" prop="elementName" />
...
const getlist = async (e) => {
  const res = await proxy.$api.AdminApi.trackList({
