<template>
  <el-dialog v-model="dialogTableVisible" title="账号详情" width="70%">
    <el-descriptions border :column=" store.openshow ?  1 : 3">
      <el-descriptions-item label="头像">
        <el-avatar :src="myinfo.headImg"/>
      </el-descriptions-item>
      <el-descriptions-item label="账号">{{ myinfo.username }}</el-descriptions-item>
      <el-descriptions-item label="昵称">{{ myinfo.nickname }}</el-descriptions-item>
      <el-descriptions-item label="手机号">{{ myinfo.iphone }}</el-descriptions-item>
