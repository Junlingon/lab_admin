    ...
    <el-descriptions border :column="store.openshow ? 1 : 3">
      ...
      <!-- <el-descriptions-item label="认证状态">
        <el-tag
          type=""
          v-if="
            myinfo.certificationStatus == 1 || myinfo.certificationStatus == 0
          "
        >
          未认证</el-tag
        >
        <el-tag type="success" v-if="myinfo.certificationStatus == 2">
          已认证</el-tag
        >
        <el-tag type="info" v-if="myinfo.certificationStatus == 3">
          审核中</el-tag
        >
        <el-tag type="danger" v-if="myinfo.certificationStatus == 4">
          未通过</el-tag
        >
      </el-descriptions-item> -->
