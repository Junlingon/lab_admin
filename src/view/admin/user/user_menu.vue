  ...
  <div class="userlist">
    <el-card shadow="always">
      <el-form :inline="true" :model="formdata" @submit.native.prevent>
        ...
        <el-form-item label="菜单状态">
          <el-select v-model="formdata.status" clearable placeholder="菜单状态">
    ...
    <el-card class="mt20">
      ...
      >
        ...
        <el-table-column label="父编号" prop="pid" />
        <el-table-column label="排序" prop="sort" />
        <el-table-column label="跳转" prop="isBlank" />
...
const getlist = async (e) => {
  const res = await proxy.$api.AdminApi.UserMenu({
